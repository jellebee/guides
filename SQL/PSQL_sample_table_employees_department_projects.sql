...
CREATE TABLE Employees (
    EmployeeID SERIAL PRIMARY KEY, -- Automatically generates a unique employee ID.
...
CREATE TABLE Departments (
    DepartmentID SERIAL PRIMARY KEY, -- Automatically generates a unique department ID.
...
CREATE TABLE Projects (
    ProjectID SERIAL PRIMARY KEY, -- Automatically generates a unique project ID.
    ProjectName VARCHAR(100) NOT NULL, -- Name of the project.
    Budget NUMERIC(12, 2) -- Financial budget allocated to the project.
);
